...
public class App {
    ...
    public static void main(String[] args) {
        ...
        ld = LocalDate.parse("02/07/2010", DateTimeFormatter.ofPattern("MM/dd/yyyy", Locale.ITALY));
        System.out.println(ld);
        ...
        // ISO is the default
        String formatted = ld.format(DateTimeFormatter.ofPattern("MM/dd/yyyy", Locale.ITALY));
        ...
        formatted = past.format(DateTimeFormatter.ofLocalizedDate(FormatStyle.LONG));
        System.out.println(formatted);
